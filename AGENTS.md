...
This public, credential-free repository owns reusable CI execution and protected acceptance-test
policy for `njrun1804-cc`. It contains checks and policy only, never application code or secrets.
